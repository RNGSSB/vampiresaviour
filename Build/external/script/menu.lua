...
menu.t_valuename = {
	...
	mashoption = {
		{itemname = 'idle', displayname = motif.training_info.menu_valuename_mashoption_idle},
		{itemname = 'counter', displayname = motif.training_info.menu_valuename_mashoption_counter},
	},
	buttonjam = {
...
menu.t_itemname = {
	...
	--Mash Option
	['mashoption'] = function(t, item, cursorPosY, moveTxt, section)
		if menu.f_valueChanged(t.items[item], motif[section]) then
			charMapSet(2, '_iksys_mashOption', menu.mashoption - 1)
		end
		return true
	end,
	--Button Jam
...
menu.t_vardisplay = {
	...
	['mashoption'] = function()
		return menu.t_valuename.mashoption[menu.mashoption or 1].displayname 
	end,
	['buttonjam'] = function()
...
function menu.f_trainingReset()
	...
	charMapSet(2, '_iksys_mashOption', 0)
